...
public class GeoHashTest {
     ...
     * Geohash hash;
     * 
     * @BeforeClass public static void start() { hash = new Geohash(); }
     */

    /*
     * @Test public void mapLengthBase32() { assertEquals(32,
     * Geohash.map.length); }
     */
    ...
    public void convertHash() {
        // decoding the hash ezs42 should translate into 01101 11111 11000 00100
        // 00010 = 0DFE082
    ...
    public void translate() {
        ...
        assertArrayEquals(/* new byte[]{0x0D,0x1F,0x18,0x04,0x02} */new byte[] { 'e', 'z', 's', '4', '2' },
                GeoHash.translateBinaryToHash(0x0DFE082, 5));
    }
